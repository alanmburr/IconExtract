...
<# 
	...
	.NOTES
	OrigionalAuthor: Chrissy LeMaire
    Author: Alan Burr: Copyright (C) 2020, Alan Burr
	Requires: PowerShell 3.0
	Version: 2.0
	DateUpdated: 2020-December-26

	.LINK 
	https://github.com/wackyblackie/IconExtract

	.EXAMPLE   
	Export-Icon C:\windows\system32\imageres.dll
	
	Exports all icons stored witin C:\windows\system32\imageres.dll to $env:temp\icons. Creates directory if required.
